...
class ImageParserV2 {
public:
	static V2Image::Format new_format_to_v2_format(Image::Format p_format, bool hacks_for_dropped_fmt);
	static Image::Format v2_format_to_new_format(V2Image::Format p_format, bool hacks_for_dropped_fmt);
	...
	static Error parse_image_construct_v2(VariantParser::Stream *f, Variant &r_v, bool hacks_for_dropped_fmt, bool convert_indexed, int &line, String &p_err_str);

	static Error decode_image_v2(FileAccess *f, Variant &r_v, bool hacks_for_dropped_fmt = true, bool convert_indexed = false);
