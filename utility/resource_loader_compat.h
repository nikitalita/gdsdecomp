...
struct ResourceData {
	...
	bool is_text;
	Map<String, List<ResourceProperty>> props;
};
...
protected:
	...
	Map<String, RES> internal_res_cache;
	...
	String get_external_resource_path(const RES &path);
	...
	bool has_external_resource(const RES &path);
