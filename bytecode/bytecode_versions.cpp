...
void register_decomp_versions() {
	...
	ObjectTypeDB::register_type<GDScriptDecomp_f3f05dc>();
	ObjectTypeDB::register_type<GDScriptDecomp_506df14>();
	ObjectTypeDB::register_type<GDScriptDecomp_0b806ee>();
	ObjectTypeDB::register_type<GDScriptDecomp_8c1731b>();
	ObjectTypeDB::register_type<GDScriptDecomp_31ce3c5>();
	ObjectTypeDB::register_type<GDScriptDecomp_703004f>();
	ObjectTypeDB::register_type<GDScriptDecomp_8cab401>();
	ObjectTypeDB::register_type<GDScriptDecomp_e82dc40>();
	ObjectTypeDB::register_type<GDScriptDecomp_2185c01>();
	ObjectTypeDB::register_type<GDScriptDecomp_97f34a1>();
	ObjectTypeDB::register_type<GDScriptDecomp_be46be7>();
	ObjectTypeDB::register_type<GDScriptDecomp_65d48d6>();
	ObjectTypeDB::register_type<GDScriptDecomp_48f1d02>();
	ObjectTypeDB::register_type<GDScriptDecomp_30c1229>();
	ObjectTypeDB::register_type<GDScriptDecomp_7d2d144>();
	ObjectTypeDB::register_type<GDScriptDecomp_64872ca>();
	ObjectTypeDB::register_type<GDScriptDecomp_6174585>();
	ObjectTypeDB::register_type<GDScriptDecomp_23441ec>();
	ObjectTypeDB::register_type<GDScriptDecomp_7124599>();
	ObjectTypeDB::register_type<GDScriptDecomp_1add52b>();
	ObjectTypeDB::register_type<GDScriptDecomp_4ee82a2>();
	ObjectTypeDB::register_type<GDScriptDecomp_513c026>();
	ObjectTypeDB::register_type<GDScriptDecomp_23381a5>();
	ObjectTypeDB::register_type<GDScriptDecomp_85585c7>();
	ObjectTypeDB::register_type<GDScriptDecomp_ed80f45>();
	ObjectTypeDB::register_type<GDScriptDecomp_8b912d1>();
	ObjectTypeDB::register_type<GDScriptDecomp_62273e5>();
	ObjectTypeDB::register_type<GDScriptDecomp_f8a7c46>();
	ObjectTypeDB::register_type<GDScriptDecomp_c24c739>();
	ObjectTypeDB::register_type<GDScriptDecomp_5e938f0>();
	ObjectTypeDB::register_type<GDScriptDecomp_015d36d>();
	ObjectTypeDB::register_type<GDScriptDecomp_c6120e7>();
	ObjectTypeDB::register_type<GDScriptDecomp_d28da86>();
	ObjectTypeDB::register_type<GDScriptDecomp_216a8aa>();
	ObjectTypeDB::register_type<GDScriptDecomp_91ca725>();
	ObjectTypeDB::register_type<GDScriptDecomp_054a2ac>();
	ObjectTypeDB::register_type<GDScriptDecomp_ff1e7cf>();
	ObjectTypeDB::register_type<GDScriptDecomp_a56d6ff>();
	ObjectTypeDB::register_type<GDScriptDecomp_3ea6d9f>();
	ObjectTypeDB::register_type<GDScriptDecomp_8e35d93>();
	ObjectTypeDB::register_type<GDScriptDecomp_a3f1ee5>();
	ObjectTypeDB::register_type<GDScriptDecomp_8aab9a0>();
	ObjectTypeDB::register_type<GDScriptDecomp_d6b31da>();
	ObjectTypeDB::register_type<GDScriptDecomp_1ca61a3>();
	ObjectTypeDB::register_type<GDScriptDecomp_1a36141>();
	ObjectTypeDB::register_type<GDScriptDecomp_514a3fb>();
	ObjectTypeDB::register_type<GDScriptDecomp_7f7d97f>();
	ObjectTypeDB::register_type<GDScriptDecomp_620ec47>();
	ObjectTypeDB::register_type<GDScriptDecomp_c00427a>();
	ObjectTypeDB::register_type<GDScriptDecomp_a60f242>();
	ObjectTypeDB::register_type<GDScriptDecomp_6694c11>();
	ObjectTypeDB::register_type<GDScriptDecomp_5565f55>();
}
