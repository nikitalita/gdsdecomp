...
class GDScriptDecomp_ee121ef : public GDScriptDecomp {
	GDCLASS(GDScriptDecomp_ee121ef, GDScriptDecomp);
protected:
	static void _bind_methods(){};
	static constexpr int bytecode_version = 100;
	static constexpr int bytecode_rev = 0xee121ef;
	static constexpr int engine_ver_major = 4;
	static constexpr int variant_ver_major = 4;
	static constexpr const char *bytecode_rev_str = "ee121ef";
	static constexpr const char *engine_version = "4.5-dev.5";
	static constexpr const char *max_engine_version = "";
	static constexpr const char *date = "2025-06-09";
	static constexpr int parent = 0xb59d6be;

	virtual Vector<GlobalToken> get_added_tokens() const override { return {GlobalToken::G_TK_PERIOD_PERIOD_PERIOD}; }
public:
