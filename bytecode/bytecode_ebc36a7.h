...
class GDScriptDecomp_ebc36a7 : public GDScriptDecomp {
	GDCLASS(GDScriptDecomp_ebc36a7, GDScriptDecomp);
protected:
	static void _bind_methods(){};
	static constexpr int bytecode_version = 101;
	static constexpr int bytecode_rev = 0xebc36a7;
	...
	virtual Vector<GlobalToken> get_removed_tokens() const override { return {GlobalToken::G_TK_ABSTRACT}; }
public:
